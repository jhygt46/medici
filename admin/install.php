...
$tablas[0]['campos'][4]['values'] = ["ef3901f2629f57c096651c2f5697f01b"];
$tablas[0]['campos'][5]['nombre'] = 'imagen';
$tablas[0]['campos'][5]['tipo'] = 'varchar(24) COLLATE utf8_spanish2_ci';
$tablas[0]['campos'][5]['null'] = 0;
$tablas[0]['campos'][5]['values'] = [""];
$tablas[0]['campos'][6]['nombre'] = 'mailcode';
$tablas[0]['campos'][6]['tipo'] = 'varchar(32) COLLATE utf8_spanish2_ci';
$tablas[0]['campos'][6]['null'] = 0;
$tablas[0]['campos'][6]['values'] = [""];
$tablas[0]['campos'][7]['nombre'] = 'titulo';
$tablas[0]['campos'][7]['tipo'] = 'varchar(100) COLLATE utf8_spanish2_ci';
$tablas[0]['campos'][7]['null'] = 0;
$tablas[0]['campos'][7]['values'] = [""];
$tablas[0]['campos'][8]['nombre'] = 'html_descripcion';
$tablas[0]['campos'][8]['tipo'] = 'TEXT';
$tablas[0]['campos'][8]['null'] = 0;
$tablas[0]['campos'][8]['values'] = [""];
$tablas[0]['campos'][9]['nombre'] = 'eliminado';
$tablas[0]['campos'][9]['tipo'] = 'tinyint(1)';
$tablas[0]['campos'][9]['null'] = 0;
$tablas[0]['campos'][9]['values'] = [0];
$tablas[0]['campos'][10]['nombre'] = 'orders';
$tablas[0]['campos'][10]['tipo'] = 'smallint(2)';
...
$tablas[5]['campos'][7]['nombre'] = 'correo';
$tablas[5]['campos'][7]['tipo'] = 'varchar(100) COLLATE utf8_spanish2_ci';
...
$tablas[5]['campos'][9]['nombre'] = 'code';
$tablas[5]['campos'][9]['tipo'] = 'varchar(32) COLLATE utf8_spanish2_ci';
$tablas[5]['campos'][9]['null'] = 0;
$tablas[5]['campos'][10]['nombre'] = 'id_ser';
$tablas[5]['campos'][10]['tipo'] = 'int(4)';
$tablas[5]['campos'][10]['null'] = 0;
$tablas[5]['campos'][10]['k'] = 1;
$tablas[5]['campos'][10]['kt'] = 3;
$tablas[5]['campos'][10]['kc'] = 0;
$tablas[5]['campos'][11]['nombre'] = 'id_usr';
$tablas[5]['campos'][11]['tipo'] = 'int(4)';
$tablas[5]['campos'][11]['null'] = 0;
$tablas[5]['campos'][11]['k'] = 1;
$tablas[5]['campos'][11]['kt'] = 0;
$tablas[5]['campos'][11]['kc'] = 0;
$tablas[5]['campos'][12]['nombre'] = 'id_suc';
$tablas[5]['campos'][12]['tipo'] = 'int(4)';
$tablas[5]['campos'][12]['null'] = 0;
$tablas[5]['campos'][12]['k'] = 1;
$tablas[5]['campos'][12]['kt'] = 1;
$tablas[5]['campos'][12]['kc'] = 0;
