...
$tablas[4]['campos'][2]['nombre'] = 'id_ser';
$tablas[4]['campos'][2]['tipo'] = 'int(4)';
$tablas[4]['campos'][2]['null'] = 0;
$tablas[4]['campos'][2]['k'] = 1;
$tablas[4]['campos'][2]['kt'] = 5;
$tablas[4]['campos'][2]['kc'] = 0;
$tablas[4]['campos'][3]['nombre'] = 'id_usr';
$tablas[4]['campos'][3]['tipo'] = 'int(4)';
$tablas[4]['campos'][3]['null'] = 0;
$tablas[4]['campos'][3]['k'] = 1;
$tablas[4]['campos'][3]['kt'] = 1;
$tablas[4]['campos'][3]['kc'] = 0;
$tablas[4]['campos'][4]['nombre'] = 'id_suc';
$tablas[4]['campos'][4]['tipo'] = 'int(4)';
$tablas[4]['campos'][4]['null'] = 0;
$tablas[4]['campos'][4]['k'] = 1;
$tablas[4]['campos'][4]['kt'] = 2;
