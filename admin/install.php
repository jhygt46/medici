...
$tablas[0]['campos'][8]['nombre'] = 'eliminado';
$tablas[0]['campos'][8]['tipo'] = 'tinyint(1)';
$tablas[0]['campos'][8]['null'] = 0;
$tablas[0]['campos'][8]['values'] = [0];
$tablas[0]['campos'][9]['nombre'] = 'orders';
$tablas[0]['campos'][9]['tipo'] = 'smallint(2)';
