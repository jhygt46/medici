            ...
            <div class="listado_items">
                ...
                <div class="l_item">
                    <div class="detalle_item clearfix">
                        ...
                        <?php if($list[$i]['eliminado'] == 0){ ?><a class="icono ic11" onclick="eliminar('<?php echo $eliminaraccion; ?>', '<?php echo $id; ?>', '<?php echo $eliminarobjeto; ?>', '<?php echo $nombre; ?>')"></a><?php }else{ ?><div class="icono"></div><?php } ?>
